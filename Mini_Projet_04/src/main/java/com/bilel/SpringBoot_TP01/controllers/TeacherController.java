...
public class TeacherController {
	...
	public void paginate(ModelMap modelMap, int page, int size) {
		Page<TeacherDTO> teachers = this.teacherService.getTeachersByPage(page, size);
	...
	public boolean contains(Teacher teacher) {
		...
		List<TeacherDTO> teachers = this.teacherService.getAllTeachers().stream()
	...
	public String createTeacher(@Valid @ModelAttribute("teacher") Teacher teacher, BindingResult bindingResult,
		...
		Page<TeacherDTO> teachers = this.teacherService.getTeachersByPage(page, 2);
	...
	public String editTeacher(ModelMap modelMap, @ModelAttribute("teacher") Teacher teacher,
		...
		Teacher t = this.teacherService.convertDtoToEntity(
				this.teacherService.getTeacher(teacher.getTeacherId())
		);
